...
-- WARN: Overwrite builtin keymap K for hovering tooltip
vim.keymap.set('n', 'K', function()
  vim.lsp.buf.hover { border = 'rounded' }
end)

-- Change indentation width explicitly for Golang
      ...
      local servers = {
        ...
        pyright = {
          settings = {
            python = {
              analysis = {
                diagnosticMode = 'off', -- nur Ruff liefert Fehler
              },
            },
          },
        },
        ruff = {
          init_options = {
            settings = {
              configuration = vim.fn.expand '~/.ruff.toml',
            },
          },
        },
        sqls = {
